...
public class CustomMethodSecurityExpressionHandler extends DefaultMethodSecurityExpressionHandler {
    ...
    public EvaluationContext createEvaluationContext(Supplier<Authentication> authentication, MethodInvocation mi) {
        CustomMethodSecurityExpressionRoot root = this.createSecurityExpressionRoot(authentication, mi);
    ...
    public CustomMethodSecurityExpressionRoot createSecurityExpressionRoot(Supplier<Authentication> authentication, MethodInvocation invocation) {
